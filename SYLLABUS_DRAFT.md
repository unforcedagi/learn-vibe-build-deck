...
- **Creativity:** making possibilities tangible, encountering what happens, and revising.

The course is structured around a stable weekly rhythm. Examples, tools, guests, and project briefs may change as the class develops; the learning contract and grading structure will not change without clear notice.

## Learning outcomes

By the end of the course, students should be able to:

1. Turn an ambiguous interest into a clear intention and workable next step.
2. Collaborate with AI across ideation, research, prototyping, debugging, revision, and critique.
3. Create and share a series of artifacts using tools appropriate to the work.
4. Describe their process, decisions, failures, and learning in their own words.
5. Give, receive, and use feedback in a studio community.
6. Evaluate AI output for quality, limits, consequences, and effects on other people.
7. Develop a personal building practice that can continue beyond this course.

## The weekly studio cycle

Most weeks use the same five-part loop:

**SEE → MAKE → SHOW → TRACE → NEXT**

Each normal weekly submission has three required parts:
...
Each weekly cycle is evaluated on a simple 10-point scale:
...
| Prepared share | 3 | The student is ready to demo, talk, or otherwise make the learning available to the room |
...
Canvas will be the official grade record. Students should be able to see how completed work maps to their current course grade.

## Attendance, sharing, and communication
...
AI use is expected. Students may use AI for ideation, research, questions, drafting, code, media generation, analysis, critique, and revision unless a specific brief says otherwise. Using AI does not transfer responsibility: students remain accountable for claims, sources, choices, effects, and submitted work.

For every Studio Cycle:
...
1. **Starting point:** Where are you beginning—from your experience with AI to what you already know how to make?
...
- Critique the work and the choices, not the worth of the person.
- Ask before sharing another student's unfinished work outside the class.
- Give specific feedback that helps someone take a next step.
- Make room; take room. Practice speaking and practice listening.
- Curiosity does not excuse harm. We remain responsible for what our work does in the world.

## CU Boulder syllabus statements (August 2026)

The statements below are adapted only to fill the course-specific procedures requested by CU. Before publishing, compare them with the university's current [Required Syllabus Statements](https://www.colorado.edu/academicaffairs/policies-guidelines/required-syllabus-statements).
...
All incidents of academic misconduct will be reported to Student Conduct & Conflict Resolution at StudentConduct@colorado.edu. Students found responsible for violating the Honor Code will be assigned resolution outcomes from Student Conduct & Conflict Resolution and will be subject to academic sanctions from the faculty member. Visit the [Honor Code](https://www.colorado.edu/sccr/honor-code) for more information.
...
If you have a temporary illness, injury, or required medical isolation for which you require adjustment, tell the instructor that you cannot attend and ask for the recovery path. You do not need to state the nature of your illness or provide a doctor's note.

### Accommodation for religious obligations

Instructional faculty members must make every reasonable effort to accommodate all students who have conflicts with scheduled exams, assignment deadlines, or required attendance due to a religious observance. Whenever possible, students must notify the instructional faculty member at least two weeks in advance of the expected exam, assignment deadline, or attendance conflict to request an accommodation for religious observance. If the start date of the course is less than two weeks before the date of requested accommodation, students must notify the instructional faculty member on the start date of the course. See the [Student Academic Accommodations for Religious Observances Policy](https://www.colorado.edu/policies/observance-religious-holidays-and-absences-classes-andor-exams) for more information.

In this class, email or speak with the instructor to request a religious accommodation. A class missed for a religious obligation will not count as an absence or use a no-fault studio pass.
...
See the Student Classroom and Course-Related Behavior Policy, Student Code of Conduct, and Office of Institutional Equity and Compliance through CU Boulder's current Required Syllabus Statements page.
...
The Office of Institutional Equity and Compliance (OIEC) addresses these concerns, and individuals who have been subjected to misconduct can contact OIEC at 303-492-2127 or OIEC@colorado.edu. Information about university policies, OIEC reporting options, and OIEC support resources including confidential services can be found on the [OIEC website](https://www.colorado.edu/oiec/).
